(function($){
    $.fn.jumboShare = function( options ) {
        ...
        function getCount(){
            ...
            /*$.getJSON('http://graph.facebook.com/?id=http://www.fagnum.com/blog/a-real-life-hero-that-india-needs&callback=?',function(d){
                    add(d.share.share_count);
                    updateCounter();
            });*/
            $.getJSON('http://graph.facebook.com/?id='+settings.url+'&callback=?',function(d){
            	add(d.share.share_count);
                updateCounter();
            });
